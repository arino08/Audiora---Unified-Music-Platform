...
public class AuthLinkBuilder {
    ...
    public String buildSpotifyAuthorizeUrl() {
        return buildSpotifyAuthorizeUrl(null);
    }
    ...
    public String buildSpotifyAuthorizeUrl(String existingSessionId) {
        ...
        String stateVal = existingSessionId != null &&
            !existingSessionId.isBlank()
    ...
    public String buildYouTubeAuthorizeUrl() {
        return buildYouTubeAuthorizeUrl(null);
    }
    ...
    public String buildGoogleAuthorizeUrl() {
        return buildGoogleAuthorizeUrl(null);
    }
